...
open class MovieClip: Sprite {
    ...
    public init(textureNames: [String], fps: UInt = 12, atlas: String = "images.atlas") {
        mFPS = fps
        super.init()
        setTextures(textureNames, atlas: atlas)
        play()
    }
    ...
    */
    ...
    open var isPlaying: Bool {
        spriteNode.action(forKey: PLAYING_KEY) != nil
    }
    override open var height: CGFloat {
        get {
            spriteNode.frame.height
        }
        set(newValue) {
